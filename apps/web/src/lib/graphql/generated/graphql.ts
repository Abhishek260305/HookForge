...
export type MeQuery = { me: { id: string, name: string | null, email: string | null, image: string | null } | null };

export type ProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectsQuery = { projects: Array<{ id: string, name: string, slug: string, environment: string }> };
